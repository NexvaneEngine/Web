			...
			<div class="nav-links" id="nav-links">
				<div class="nav-button dropdown">
					...
					<div class="dropdown-content">
						<a href="${base}download/windows.html"><i class="bi bi-windows nav-button-icon"></i>Windows</a>
						<a href="${base}download/linux.html"><i class="bi bi-tux nav-button-icon"></i>Linux</a>
						<a href="${base}download/source.html"><i class="bi bi-git nav-button-icon"></i>Source</a>
					</div>
				</div>
				...
				<div class="nav-button dropdown">
					...
					<div class="dropdown-content">
						<a href="${base}manual.html"><i class="bi bi-person-fill-down nav-button-icon"></i>User Manual</a>
						<a href="${base}manual/api.html"><i class="bi bi-journal-code nav-button-icon"></i>API Reference</a>
					</div>
				</div>
				...
				<div class="nav-button dropdown">
					...
					<div class="dropdown-content">
						<a href="${base}about/engine.html"><i class="bi bi-joystick nav-button-icon"></i>Nexvane</a>
						<a href="${base}about/fotosop.html"><i class="bi bi-building-fill nav-button-icon"></i>Fotosop</a>
						<a href="${base}about/acrux.html"><i class="bi bi-building-fill nav-button-icon"></i>Acrux</a>
					</div>
				</div>
			</div>
			...
			<div class="nav-right" id="nav-right">
				<div class="nav-button dropdown">
					...
					<div class="dropdown-content dropdown-right">
						<a href="${base}user/profile.html"><i class="bi bi-person-fill nav-button-icon"></i>Profile</a>
						<a href="${base}user/settings.html"><i class="bi bi-gear-fill nav-button-icon"></i>Settings</a>
